...
public class CreateFMODDataTestsEditor : EditorWindow
{
    ...
    [MenuItem("Studio-23/Audio System/Generate data for Tests")]
    public static void GenerateTestData()
    {
        ...
        GetAllData(_testFolderPath, _testNameSpace);
    }
    ...
    {
        string filename = $"Test_FMODBankList";
    ...
    {
        string filename = $"Test_FMODBusList";
    ...
    {
        string filename = $"Test_FMODVCAList";
    ...
    {
        string filename = $"Test_FMODLocaleList";
    ...
    private static void GenerateEventList(string folderPath, string nameSpace)
    {
        for (int i = 0; i < _eventList.Count; i++)
        {
            ...
            string filename = $"Test_FMODBank_{_eventList.ElementAt(i).Key.Replace("bank:/", "").Replace(" ", "_").Replace(":/", "_").Replace("/", "_").Replace("-", "_")}";
    ...
    {
        string filename = $"Test_FMODParameterList";
