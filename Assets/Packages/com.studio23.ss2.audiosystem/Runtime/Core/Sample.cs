...
public class Sample : MonoBehaviour
{
    ...
    //{
    //    AudioManager.Instance.CreateEmitter(FMODBank_Dialogue.Dialogue_Dialogue, gameObject);
    //}
    ...
    //{
    //    AudioManager.Instance.PlayExternal("goodbye", FMODBank_Dialogue.Dialogue_Dialogue, gameObject);
    //}
