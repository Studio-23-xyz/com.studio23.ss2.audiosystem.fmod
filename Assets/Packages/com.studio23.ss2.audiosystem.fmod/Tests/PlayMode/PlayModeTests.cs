...
namespace Studio23.SS2.AudioSystem.fmod.Tests.Playmode
{
    public class PlayModeTests
    {
        ...
        {
            _fmodManager.MixerManager.PauseBus(Test_FMODBusList.SFX, true);
        ...
        {
            _fmodManager.MixerManager.PauseBus(Test_FMODBusList.SFX, false);
        ...
        {
            _fmodManager.MixerManager.MuteBus(Test_FMODBusList.SFX, true);
        ...
        {
            _fmodManager.MixerManager.MuteBus(Test_FMODBusList.SFX, false);
        ...
        public IEnumerator CreateEmitter()
        {
            ...
            Assert.IsTrue(_fmodManager.EventsManager._emitterDataList[(Test_FMODBank_Test.Test, _fmodManager.gameObject.GetInstanceID())] != null);
            yield return null;
        }
        ...
        public IEnumerator PlaySound()
        {
            ...
            Assert.IsTrue(_fmodManager.EventsManager._emitterDataList[(Test_FMODBank_Test.Test, _fmodManager.gameObject.GetInstanceID())].EventState == FMODEventState.Playing);
            yield return null;
        }
        ...
        public IEnumerator PauseSound()
        {
            ...
            Assert.IsTrue(_fmodManager.EventsManager._emitterDataList[(Test_FMODBank_Test.Test, _fmodManager.gameObject.GetInstanceID())].EventState == FMODEventState.Suspended);
            yield return null;
        }
        ...
        {
            _fmodManager.EventsManager.TogglePause(true);
            Assert.IsTrue(_fmodManager.EventsManager._emitterDataList[(Test_FMODBank_Test.Test, _fmodManager.gameObject.GetInstanceID())].EventState == FMODEventState.Paused);
            yield return null;
        }
        ...
        {
            _fmodManager.EventsManager.TogglePause(false);
            Assert.IsTrue(_fmodManager.EventsManager._emitterDataList[(Test_FMODBank_Test.Test, _fmodManager.gameObject.GetInstanceID())].EventState == FMODEventState.Playing);
            yield return null;
        }
        ...
        public IEnumerator StopSound() => UniTask.ToCoroutine(async () =>
        {
            ...
            Assert.IsTrue(_fmodManager.EventsManager._emitterDataList[(Test_FMODBank_Test.Test, _fmodManager.gameObject.GetInstanceID())].EventState == FMODEventState.Stopped);
        });
        ...
        public IEnumerator SetLocalParameterByName()
        {
            ...
            _fmodManager.EventsManager._emitterDataList[(Test_FMODBank_Test.Test, _fmodManager.gameObject.GetInstanceID())].Emitter.EventInstance
        ...
        public IEnumerator ReleaseSound() => UniTask.ToCoroutine(async () =>
        {
            ...
            Assert.IsFalse(_fmodManager.EventsManager._emitterDataList.ContainsKey((Test_FMODBank_Test.Test, _fmodManager.gameObject.GetInstanceID())));
        });
